...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Services from Marcello Genovese — product and growth advisory, technology guidance, brand and positioning, and funding preparation.",
};
  ...
  return (
    <main className="min-h-screen w-full bg-[#cecbc8]">
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12 xl:px-14 2xl:px-0 pt-32 pb-24">
        <p className="font-geist text-[18px] text-[#6b6866] mb-6">(Services)</p>
